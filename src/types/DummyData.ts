...
export const DUMMY_PROJECTS: Project[] = [
  {
    ...
    title: "Analisis Dinamika Opini Publik terhadap Penyakit Diabetes",
    description:
    ...
    topic_category: "Penyakit Diabetes",
    start_date_crawl: "2025-01-01",
    end_date_crawl: "2025-01-31",
    keyword: "Penyakit Diabetes",
    language: "id",
  },
  {
    _id: "dummy-project-002",
    title: "Analisis Opini Publik terhadap Ny Liem",
    description:
    ...
    keyword: "toko dan bahan kue ny.liem",
    language: "id",
  },
  {
    ...
    keyword: "tren euro truck simulator 2",
    language: "id",
  },
];
...
export const DUMMY_TOPICS: Topic[] = [
  {
    context:
      "Topik ini tentang bagaimana diabetes mellitus meningkatkan risiko sakit akibat tingginya kadar gula darah dan peran insulin dalam menjaga tingkat gula tetap sehat saat makan.",
    keyword: "Penyakit Diabetes",
  ...
  {
    context:
      "Topik ini tentang pentingnya mengatur pola makan untuk mencegah diabetes mellitus dengan cara menurunkan kadar gula darah yang tinggi dan mengelola insulin agar tetap sehat meski ada risiko sakit.",
    keyword: "Penyakit Diabetes",
    projectId: "dummy-project-001",
    topicId: 2,
    words: [
  ...
  {
    context:
      "Topik ini tentang rekam momen alami pour topping manis di toko kue Ny Liem, merek lokal nyc ling, yang ditatap sepenuh jiwa bak dream coming true.",
    keyword: "Toko dan Bahan Kue Ny.Liem",
  ...
  {
    context:
      "Topik ini tentang gemasnya karya kue Ny Liem, ekspresi hidup dream chan yang mengiringi work dengan musik manis, bikin suka dan selamat menikmati.",
    keyword: "Toko dan Bahan Kue Ny.Liem",
    projectId: "dummy-project-002",
    topicId: 3,
    words: [
  ...
  {
    context:
      "Topik ini tentang kue Ny Liem yang punya vois manis, tampil tanpa dramatis hamas, jadi mode langkah tepat para wanita, bantu cari waktu me-time, kasih sensasi lycan.",
    keyword: "Toko dan Bahan Kue Ny.Liem",
    projectId: "dummy-project-002",
    topicId: 3,
    words: [
